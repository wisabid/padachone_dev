...
export const addAlert = async ({ prayer, time }) => {
  ...
  if (messaging) {
    ...
    // const token =
    //   "fbpxzsN80YA:APA91bHcWD6nRpEH5SBIyGYk-shFTmSrGOHgdF28NV3JlxH7POSig1CTExAPp2HYm3FhjG9wZY9ww1KFtxRlfNA39xwW2Q8kdKnPxOcafP_79B8rnvbpW0nAxGeXUlxTYyc2H1D1i_hK";
